...
const Hero = () => {
  return (
    <div>
      <Container>
        <section className=" hero bg-white min-h-screen lg:flex-row flex flex-col lg:items-center lg:justify-between justify-start lg:px-12 md:px-8 sm:px-6 px-6 py-8">
        <motion.div
