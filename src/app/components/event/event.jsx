        ...
        <div className="text-center mb-8 p-4">
          ...
          <div className="text-[#000000] mb-4">
            <p className="text-4xl font-bold mb-2">
              Senyum Semangat, Juara Bersama
            </p>
            <p className="text-sm mt-4 text-[#585454]">
              Mari rayakan kemerdekaan Indonesia dengan semangat yang membara!
              Lomba 17 Agustus ini tidak hanya sekadar perlombaan, tetapi juga
              ajang untuk mempererat tali silaturahmi dan menumbuhkan rasa cinta
              tanah air.
            </p>
          </div>
        </div>
          ...
          >
            {slides.map((slide, index) => (
              ...
              >
                ...
                <p className="text-2xl font-bold text-[#000000] mt-4">
                  {slide.caption}
                </p>
              </div>
            ))}
